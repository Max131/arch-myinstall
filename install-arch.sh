...
sleep 2s
pacstrap /mnt base base-devel linux-zen linux-zen-headers linux-firmware grub os-prober networkmanager vim mlocate sudo zsh pulseaudio pulsemixer alsa-utils unzip unrar nethogs man-db man-pages amd-ucode arch-wiki-lite arch-wiki-docs terminus-font 
